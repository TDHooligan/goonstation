// AUGMENT HOLDER
// Designed to handle a single object's attached augments.

/datum/component/augment_holder
	dupe_mode = COMPONENT_DUPE_UNIQUE
	var/list/obj/item/augment/primary_augments
	var/list/obj/item/augment/auxiliary_augments

TYPEINFO(/datum/component/augment_holder)
	initialization_args = list(
//		ARG_INFO("new_cell", DATA_INPUT_REF, "ref to cell that will be first used"),
	)

/datum/component/augment_holder/Initialize(atom/movable/new_cell, chargable = TRUE, max_cell = INFINITY, swappable = TRUE, restrict_cell = null)
	. = ..()
